...
**Canonical version:** `v1.0.0-rc3-web-005a-hero-visual-revision` — WEB-005A R3 `REVISION_REQUIRED`; third preview gate submitted (release candidate unchanged)
**Date:** 2026-09-18
...
**WEB-005A R3 preview gate 3:** `tasks/WEB-005A_R3_PREVIEW_GATE_3.md` — `PREVIEW_GATE_3_SUBMITTED`, awaiting Product/CTO; no production render made
