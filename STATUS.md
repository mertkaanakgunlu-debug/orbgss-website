...
**Canonical version:** `v1.0.0-rc5-web-005b-r3-delivery` — WEB-005B `REVIEW_READY` after the bounded R3 delivery-encoding pass (homepage Acts 2-4 on the terminally accepted hero)
**Date:** 2026-09-20
